...
import { FilterList, FilterListParams, Province } from 'types';
...
export default function TableToolbar(props: Props) {
  ...
  const { isLoadingExportUpgradeKis } = useSelector(selectMemberReport);
  ...
  useEffect(() => {
    if (!isLoadingExportUpgradeKis) {
      setOpenExportDialog(false);
    }
  }, [isLoadingExportUpgradeKis]);
  ...
  return (
    <RootStyle>
      ...
      <ExportExCel
        isLoading={isLoadingExportUpgradeKis}

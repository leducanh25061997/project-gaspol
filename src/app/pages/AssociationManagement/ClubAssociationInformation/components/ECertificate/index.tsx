...
export const ECertificate = memo((props: Props) => {
    ...
    <Grid mt={2}>
      <Card>
        <Grid container justifyContent={'space-between'} mt={1}>
          <TitlePage>
            {t(translations.clubAssociationInformation.ECertificate)}
          </TitlePage>
        ...
        <Box sx={{ mt: 4 }}>
          <TextField
            placeholder="E-Certificate number"
            error={!!certError}
            ...
            onChange={ev => {
              ...
              setCertError(
                value.length ? undefined : 'E-Certificate number is required!',
              );
            }}
            fullWidth
            InputLabelProps={{
